...
while True:
    ...
    # App Open Commands
        ...
        speak("Aap 'open chrome', 'open youtube' ya 'open notepad' bol kar try karein.")import tkinter as impimportt requests
importf get_crypto_price():
    try:
...
root.mainloop()from flask import Flask, request
import requests
